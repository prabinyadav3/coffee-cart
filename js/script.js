...
function initializeItem1() {
  ...
  <img src="../img/caffe-americano.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount1">Rs.{item1Counter}</p>
      <div class="item1Down">
...
function initializeItem2() {
  ...
  <img src="../img/caffe-misto.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount2">Rs.{item2Counter}</p>
      <div class="item2Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem3() {
  ...
  <img src="../img/caffe-americano.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount3">Rs.{item3Counter}</p>
      <div class="item3Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem4() {
  ...
  <img src="../img/dark-roast-coffee.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount4">Rs.{item4Counter}</p>
      <div class="item4Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem5() {
  ...
  <img src="../img/dark-roast-coffee.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount5">Rs.{item5Counter}</p>
      <div class="item5Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem6() {
  ...
  <img src="../img/dark-roast-coffee.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount6">Rs.{item6Counter}</p>
      <div class="item6Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem7() {
  ...
  <img src="../img/dark-roast-coffee.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount7">Rs.{item7Counter}</p>
      <div class="item7Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem8() {
  ...
  <img src="../img/cappuccino.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount8">Rs.{item8Counter}</p>
      <div class="item8Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem9() {
  ...
  <img src="../img/cappuccino.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount9">Rs.{item9Counter}</p>
      <div class="item9Down">
      <i class="fas fa-chevron-down"></i>
      </div>
    </div>
...
function initializeItem10() {
  ...
  <img src="../img/espresso.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount10">Rs.{item10Counter}</p>
...
function initializeItem11() {
  ...
  <img src="../img/espresso-macchiato.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount11">Rs.{item11Counter}</p>
...
function initializeItem12() {
  ...
  <img src="../img/flat-white.jpg" alt="product" />
    ...
    <div>
      ...
      <p class="item-amount12">Rs.{item12Counter}</p>
